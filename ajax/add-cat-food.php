...
if (isset($_POST['status']) AND isset($_POST['reservationID']) AND isset($_POST['foodType']) AND isset($_POST['feedingInstructions'])) {
  ...
  $sql_add_food="INSERT INTO cats_food (catReservationID, foodType, feedingInstructions, specialNotes, status) VALUES ('$reservationID', '$foodType', '$feedingInstructions', '$specialNotes', '$status')";
