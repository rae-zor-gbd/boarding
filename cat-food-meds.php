...
<html lang='en'>
    ...
    <script type='text/javascript'>
      ...
      $(document).ready(function(){
        ...
        $('#addFood').click(function (e) {
          ...
          var reservationID=document.getElementById('newCat').value;
          ...
          <?php
          $sql_add_tags="SELECT tagID FROM tags WHERE forCats='Yes' ORDER BY tagID";
        ...
        $('#editCat').click(function (e) {
          ...
          <?php
          $sql_edit_tags="SELECT tagID FROM tags WHERE forCats='Yes' ORDER BY tagID";
          ...
          if (id!='' && status!='' && foodType!='' && feedingInstructions!='') {
            ...
            loadIncompleteFormAlert('#editCatModalBody');
          }
        });
  ...
  <body>
    ...
    <form action='' method='post' spellcheck='false' autocomplete='off' id='editCatForm'>
    ...
    <form action='' method='post' spellcheck='false' autocomplete='off' id='deleteCatForm'>
